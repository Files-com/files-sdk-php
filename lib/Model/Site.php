...
class Site
{
    ...
    public static function update($params = [], $options = [])
    {
        ...
        if (@$params['document_edits_in_bundle_allowed'] && !is_string(@$params['document_edits_in_bundle_allowed'])) {
            throw new \Files\Exception\InvalidParameterException('$document_edits_in_bundle_allowed must be of type string; received ' . gettype(@$params['document_edits_in_bundle_allowed']));
        }
