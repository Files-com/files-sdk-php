...
```
$metadata_category = new \Files\Model\MetadataCategory();
$metadata_category->list
```
...
```
$metadata_category = new \Files\Model\MetadataCategory();
$metadata_category->listFor($path);
```
