...
class UserSftpClientUse
{
    ...
    {
        return @$this->attributes['sftp_client'];
    }
    ...
    public static function all($params = [], $options = [])
    {
        ...
        $response = Api::sendRequest('/user_sftp_client_uses', 'GET', $params, $options);

        $return_array = [];

        foreach ($response->data as $obj) {
            $return_array[] = new UserSftpClientUse((array) $obj, $options);
        }
    ...
    public static function createExport($params = [], $options = [])
    {
        ...
        $response = Api::sendRequest('/user_sftp_client_uses/create_export', 'POST', $params, $options);
