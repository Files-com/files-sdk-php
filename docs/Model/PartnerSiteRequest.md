...
```
$partner_site_request = new \Files\Model\PartnerSiteRequest();
$partner_site_request->findByPairingKey(, [
...
```
$partner_site_request = current(\Files\Model\PartnerSiteRequest::all());
