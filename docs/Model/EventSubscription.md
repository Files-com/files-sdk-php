...
```
$event_subscription = new \Files\Model\EventSubscription();
$event_subscription->list
```
...
```
$event_subscription = \Files\Model\EventSubscription::find($id);
