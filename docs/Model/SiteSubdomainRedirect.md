...
```
$site_subdomain_redirect = new \Files\Model\SiteSubdomainRedirect();
$site_subdomain_redirect->list
```
...
```
$site_subdomain_redirect = new \Files\Model\SiteSubdomainRedirect();
$site_subdomain_redirect->find($id);
```
...
```
$site_subdomain_redirect = \Files\Model\SiteSubdomainRedirect::find($id);
