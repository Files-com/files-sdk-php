...
class Workspace
{
    ...
    public static function all($params = [], $options = [])
    {
        ...
        $response = Api::sendRequest('/workspaces', 'GET', $params, $options);

        $return_array = [];

        foreach ($response->data as $obj) {
            $return_array[] = new Workspace((array) $obj, $options);
        }
    ...
    public static function create($params = [], $options = [])
    {
        ...
        $response = Api::sendRequest('/workspaces', 'POST', $params, $options);
