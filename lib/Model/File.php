...
class File
{
    ...
    public function getCopyBehaviors()
    {
        return @$this->attributes['copy_behaviors'];
    }

    public function setCopyBehaviors($value)
    {
        return $this->attributes['copy_behaviors'] = $value;
    }
