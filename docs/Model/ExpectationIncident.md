...
```
$expectation_incident = new \Files\Model\ExpectationIncident();
$expectation_incident->list
```
...
```
$expectation_incident = \Files\Model\ExpectationIncident::find($id);
