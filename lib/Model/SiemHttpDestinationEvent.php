...
class SiemHttpDestinationEvent
{
    ...
    public static function all($params = [], $options = [])
    {
        ...
        $response = Api::sendRequest('/siem_http_destination_events', 'GET', $params, $options);

        $return_array = [];

        foreach ($response->data as $obj) {
            $return_array[] = new SiemHttpDestinationEvent((array) $obj, $options);
        }
    ...
    public static function find($id, $params = [], $options = [])
    {
        ...
        $response = Api::sendRequest('/siem_http_destination_events/' . rawurlencode(strval(@$params['id'])) . '', 'GET', $params, $options);

        return new SiemHttpDestinationEvent((array) (@$response->data ?: []), $options);
    }
