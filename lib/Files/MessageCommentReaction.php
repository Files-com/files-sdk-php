...
class MessageCommentReaction {
  ...
  public function delete($params = []) {
    ...
    return Api::sendRequest('/message_comment_reactions/' . $params['id'] . '', 'DELETE', $params);
  }
  ...
  public function save() {
    if ($this->attributes['id']) {
      throw new \BadMethodCallException('The MessageCommentReaction object doesn\'t support updates.');
    } else {
  ...
  public static function list($params = [], $options = []) {
    ...
    if ($params['message_comment_id'] && !is_int($params['message_comment_id'])) {
      throw new \InvalidArgumentException('Bad parameter: $message_comment_id must be of type int; received ' . gettype($message_comment_id));
    }

    $response = Api::sendRequest('/message_comment_reactions', 'GET', $params);
  ...
  public static function find($id, $params = [], $options = []) {
    ...
    $response = Api::sendRequest('/message_comment_reactions/' . $params['id'] . '', 'GET', $params);
  ...
  public static function create($params = [], $options = []) {
    ...
    $response = Api::sendRequest('/message_comment_reactions', 'POST', $params);
